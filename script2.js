...
//   document.querySelector(".anim").appendChild(walkingPic);
//   const gdBtn = document.getElementById("gd");

//   gdBtn.addEventListener("click", function () {
//     document.querySelector(".anim").innerHTML = walkingPic[i];
//   });
// }
...
// imgNode.innerHTML = document.getElementById("walkingPic");
